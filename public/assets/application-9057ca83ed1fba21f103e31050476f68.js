...
////////console.log("-11111111111")
  ...
  $(".switcher").on("click", function(e) {
      ...
      ////////console.log($this)
      ////////console.log("$this")
      //here i can store the latest element click id
      ////////console.log($this.attr('id'))
      //if this is undefined then it is drop box
      //also i can store a type of this
      
        
       if($this.attr("data-option-disables")) {
          var $disables = JSON.parse($this.attr("data-option-disables"));
        }
        //now there is need to remove an element after the unclick of first element that is in array
        //this element is second element. so to check this in the remove i need to search in the 
        //so what new things i need to do is create a seperate loop on .lock variable
        //in that just search the second element if that is not clicked then remove that text id.
        ////////console.log("the disabled are null")
        ////////console.log($disables)
        ////////console.log($this.attr('id'))
        ////////console.log($this.attr('name'))
        ////////console.log($this.attr('data-option-uniq-id'))
        //the select box disables are not shown that is why now need to check weather its a select box or not
        ////////console.log($this.prop('tagName'))
        if(typeof $disables == 'undefined')
        {
            //check weather it is a select if yes then get its selected element and then take its disables
            if($this.prop('tagName') == "SELECT")
            {
                //if 
                ////////console.log($this.selected)
                ////////console.log("$this.selected")
                //option:selected").attr('data-option-disables')
              ...
              ////////console.log($disables)
               ////////console.log("$disables from select tag")
               
            
            }
            
        }//first of all its taking its disables.
        
        
       // $disables = false
     //then there is a loop on disables.  
     //console.log("there need to change an id of input ")
     //console.log($disables)
     ...
     if($disables) {
      ...
      input = document.createElement( "input" );
      // the value will be the element which is clicked and tyhen enter word and then its disabled name
      ...
      {
          //it might happen that it not  drop down but it is a radio then try input
         dis_uniq_attr = $("input[data-option-id='" + $disables[i] +"']").attr('data-option-uniq-id')
        ////////console.log ("it is undefined")
        ////////console.log (dis_uniq_attr)
      }
         ...
         {
             //it might be an select and that is why now need to get an options uniq id
